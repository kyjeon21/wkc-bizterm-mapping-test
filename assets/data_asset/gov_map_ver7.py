...
class WatsonDataAPI:
    ...
    def get_artifact_info(self, metadata_name, artifact_type):
        #print("★★★ WatsonDataAPI.get_artifact_info ★★★")
        headers = {
    ...
    def get_catalog_id(self, catalog_name):
        #print("★★★ WatsonDataAPI.get_catalog_id ★★★")
    ...
    def get_category_id(self, category_name):
        #print("★★★ WatsonDataAPI.get_category_id ★★★")
        try:
            headers = {
                'Content-Type': "application/json",
                'Authorization': "Bearer "+self.token,
    ...
    def get_asset_info(self,asset_id,catalog_id):
        #print("★★★ WatsonDataAPI.get_asset_info ★★★")
        headers = {
            'Content-Type': "application/json",
            'Authorization': "Bearer "+self.token
        }
    ...
    def get_asset_id_in_project(self):
        #print("★★★ WatsonDataAPI.get_asset_id_in_project ★★★")
    ...
    def get_asset_id_in_catalog(self, catalog_name):
        #print("★★★ WatsonDataAPI.get_asset_id_in_catalog ★★★")
    ...
    def get_terms_id(self, category_name):
        #print("★★★ WatsonDataAPI.get_terms_id ★★★")
    ...
    def map_terms_to_asset(self, map_terms_csv):
        #print("★★★ WatsonDataAPI.map_terms_to_asset ★★★")
        catalog2id =dict()
        category2id = dict()
        terms2id = dict()
    ...
    def get_cpd_cluster_host(self):
        #print("★★★ WatsonDataAPI.get_cpd_cluster_host ★★★")
        return self.cpd_cluster_host

    def get_project(self):
        #print("★★★ WatsonDataAPI.get_project ★★★")
        return self.project
